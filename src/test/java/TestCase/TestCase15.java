...
public class TestCase15 { 
	...
	//TestCase15: Verify search product in product page and click on sign out
	...
	productfilter_dashboard.seemoreBrand();
	productfilter_dashboard.selectJockey();
	}	
	@Test(priority=4)
	public void SignOut()
	{
