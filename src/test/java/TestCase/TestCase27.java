...
public class TestCase27 {
	...
	//TestCase27: Verify quantity, total price are added in cart and click on sign out button
	...
	loginpage.move();
	loginpage.signin();
	loginpage.mobilenumber("1234567898");
	...
	search_dashboard.search("Allen Solly");
